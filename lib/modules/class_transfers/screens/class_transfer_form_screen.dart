...
class ClassTransferFormScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SimpleFormScreen(
      title: classTransfer == null ? 'Create Class Transfer' : 'Update Class Transfer',
      fields: const [
        ...
        FormFieldConfig(name: 'to_class_id', label: 'To class ID', keyboardType: TextInputType.number),
        FormFieldConfig(name: 'to_class_name', label: 'To class'),
        FormFieldConfig(name: 'reason', label: 'Reason', maxLines: 2),
        FormFieldConfig(name: 'effective_date', label: 'Effective date (YYYY-MM-DD)'),
      ],
      initialValues: {
