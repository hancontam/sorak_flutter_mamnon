...
| SORAK-TEST-011 | High | Contract gap | Parent Health/Growth endpoints do not exist | Backend health routes allow staff only; proposed secure shape is documented in `backend_parent_read_api_contract.md` | Backend deploys ownership-scoped read APIs and Parent live journey parses real records |
